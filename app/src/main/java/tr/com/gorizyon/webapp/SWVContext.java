package tr.com.gorizyon.webapp;
...
public class SWVContext {
    ...
    public static void loadConfig(Context context) {
        ...
        // --- URL Configuration ---
        ASWV_APP_URL = config.getString("app.url", "https://gorizyon.com.tr");
        ...
        ASWV_EXC_LIST = config.getString("external.url.exception.list", "app.gorizyon.com.tr,gorizyon.com");
        ...
        USER_AGENT_POSTFIX = config.getString("agent.postfix.value", "GorizyonAPP");
    ...
    public static void loadPlugins(Context context) {
        ...
        try {
            ...
            String pluginPackageName = "tr.com.gorizyon.webapp.plugins";
    ...
    public static final Map<Integer, NavItem> ASWV_DRAWER_MENU = new HashMap<Integer, NavItem>() {{
        put(R.id.nav_home, new NavItem(R.id.nav_home, "https://gorizyon.com.tr"));
        put(R.id.nav_doc, new NavItem(R.id.nav_doc, "https://gorizyon.com.tr/app/documentation/"));
        put(R.id.nav_plugins, new NavItem(R.id.nav_plugins, "https://gorizyon.com.tr/app/documentation/plugins/"));
        put(R.id.nav_psg, new NavItem(R.id.nav_psg, "https://gorizyon.com.tr/app/documentation/play-store-guide/"));
        put(R.id.nav_support, new NavItem(R.id.nav_support, "mailto:help@gorizyon.com.tr?subject=Help: Smart WebView"));
    }};
}