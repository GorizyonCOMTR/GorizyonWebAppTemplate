package tr.com.gorizyon.webapp.plugins;
...
import tr.com.gorizyon.webapp.Functions;
import tr.com.gorizyon.webapp.PluginInterface;
import tr.com.gorizyon.webapp.PluginManager;
import tr.com.gorizyon.webapp.R;
import tr.com.gorizyon.webapp.SWVContext;
...
public class BiometricPlugin implements PluginInterface {
    ...
    private void showOverlay() {
        ...
        if (activity instanceof tr.com.gorizyon.webapp.MainActivity) {
            ((tr.com.gorizyon.webapp.MainActivity) activity).setWindowSecure(true);
        }
    ...
    private void hideOverlay() {
        ...
        if (activity instanceof tr.com.gorizyon.webapp.MainActivity) {
            ((tr.com.gorizyon.webapp.MainActivity) activity).setWindowSecure(false);
        }
        activity.runOnUiThread(() -> {
