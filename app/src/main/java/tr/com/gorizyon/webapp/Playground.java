...
public class Playground {
    ...
    private void configurePlugins() {
        ...
        runPluginAction("AdMobPlugin", plugin -> {
            ...
            if (config != null) {
                config.put("bannerAdUnitId", "ca-app-pub-1626535161187974/7775657663");
                config.put("interstitialAdUnitId", "ca-app-pub-1626535161187974/2341487252");
                config.put("rewardedAdUnitId", "ca-app-pub-1626535161187974/6280732262");
            }
        });
